...
func loadPackages() []string {
	...
	if err != nil {
		log.Printf("Error opening packages.txt: %v", err)
		return []string{}
	}
	defer file.Close()
...
<footer style="position:fixed;bottom:0;left:0;right:0;display:flex;justify-content:space-between;align-items:center;padding:10px;background:linear-gradient(transparent,rgba(248,249,250,0.9))">
<span></span>
...
<span style="color:#999;font-size:11px;display:flex;align-items:center">v1.0.1</span>
</footer>
</body>
<script>
